  ...
  useEffect(() => {
    const handleResize = () => {
      if (window.innerWidth < 768) {
        ...
        setIsMobile(false); // Desktop or tablet detected
      }
    };
              ...
              <div className="flex-1 text-center space-y-2 lg:space-y-6f flex flex-col gap-6">
                <p className="hidden lg:block sm:text-md md:text-lg leading-relaxed text-black">
                  ...
                  <span className="xl:block hidden">
                    Our collection is thoughtfully crafted to combine
                    cutting-edge style with unmatched durability, ensuring
                    you’re always ready for whatever life throws your way.{" "}
                    <br />
                  </span>
                  Whether you're dressing for a casual day out or a formal
                  event, Defender offers premium-quality products that
                  prioritize comfort, elegance, and individuality. Join
                  thousands of satisfied customers who trust Defender to
            ...
            <div className="flex flex-col lg:flex-row justify-center items-center w-full space-y-8 lg:space-y-0">
              ...
              >
                ...
                <p className="mb-4 text-justify text-sm lg:text-lg">
                  At Defender, our mission is to redefine the way you think
                  about fashion. We believe in creating stylish, durable, and
              ...
              >
                ...
                <ul className="list-disc pl-5 space-y-2 text-justify mb-3 lg:mb-4 text-sm lg:text-lg">
                  <li>
                    <strong>Quality:</strong> Premium materials and
                    craftsmanship to ensure lasting durability.
                  </li>
                  ...
                  <li className="hidden lg:block">
                    <strong>Customer-Centricity:</strong> Our customers are at
                    the heart of everything we do, ensuring satisfaction in
                    every interaction.
                  </li>
                </ul>
                ...
                <div className="text-sm lg:text-lg text-justify">
                  ...
                  <ul className="list-none">
                    ...
                    <li className="mb-2">
                      <strong>Address:</strong> Defender, Taj Al Samy Trading
                      EST, Al Samra, Hail, KSA 55425
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-6 lg:gap-0 lg:flex-row lg:items-center">
                ...
                <div className="flex-1 text-center space-y-6 flex flex-col gap-6">
                  <p className="sm:text-md md:text-lg leading-relaxed">
                    At Defender, we believe fashion is more than just what you
                    wear – it's how you express yourself, conquer challenges,
            ...
            >
              ...
              <div className="flex flex-col lg:flex-row justify-center items-center w-full space-y-8 lg:space-y-0 ">
                ...
                >
                  ...
                  <p className="text-justify text-sm lg:text-lg">
                    To become a global leader in fashionable yet durable
                    clothing that enables individuals to express their unique
                    style, while always prioritizing comfort and performance.
                  </p>
                </div>
                <div
